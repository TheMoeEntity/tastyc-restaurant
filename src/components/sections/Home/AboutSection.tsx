  ...
  return (
    <section className="w-full px-6 md:px-16 lg:px-20">
      ...
      ">
        ...
        {/* 🔥 BLENDED SEMILUNAR SCROLL INDICATOR */}
        <div className="absolute -top-10 left-1/2 -translate-x-1/2 flex items-end justify-center">
          ...
          ">
            ...
            {/* INNER CIRCLE */}
            <div className="w-8 h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 border-2 border-gray-300 rounded-full flex items-start justify-center p-1">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-6 order-1 lg:order-2">
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
              Assumenda possimus eaque illo iste, autem. Porro eveniet, autem ipsam
              vitae amet repellat repudiandae tenetur, quod corrupti consectetur
              cum? Repudiandae dignissimos fugiat sit nam. Tempore aspernatur quae
              repudiandae dolorem, beatae dolorum, praesentium itaque et quam
              quaerat. Cumque, consequatur!
            </p>
