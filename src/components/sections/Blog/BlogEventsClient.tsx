...
import { Calendar, Clock, Search, User, MessageCircle, ChevronRight, Star, ArrowLeft, CalendarDays, Mail, CheckCircle } from "lucide-react";
...
interface BlogEventsClientProps {
  initialPosts: BlogPost[];
  upcomingEvent: BlogPost | undefined;
}

export function BlogEventsClient({ initialPosts, upcomingEvent }: BlogEventsClientProps) {
        ...
        <div className="max-w-7xl mx-auto">
          {displayedPosts.length === 0 ? (
            <div className="text-center py-12">
              ...
              <button onClick={() => setSearchQuery("")} className="mt-4 text-yellow-600 hover:text-yellow-700 font-semibold">
                Clear search
              </button>
            </div>
          ) : (
