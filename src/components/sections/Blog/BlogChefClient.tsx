...
import { Calendar, Clock, Search, MessageCircle, ChevronRight, Star, ArrowLeft, Quote, Briefcase, ChefHat, CheckCircle } from "lucide-react";
...
interface BlogChefClientProps {
  initialPosts: BlogPost[];
  chefs: BlogAuthor[];
  featuredStory: BlogPost | undefined;
}

export function BlogChefClient({ initialPosts, chefs, featuredStory }: BlogChefClientProps) {
  ...
  useEffect(() => {
    ...
    setCurrentPage(1);
  }, [searchQuery, selectedChef, initialPosts]);
