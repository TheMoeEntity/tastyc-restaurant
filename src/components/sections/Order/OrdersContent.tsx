...
export function OrdersContent() {
  ...
  return (
    <>
      ...
      {/* EMPTY STATE CTA - WITHOUT BACKGROUND IMAGE */}
      {orders.length === 0 && (
        <section className="relative py-12 sm:py-20 px-4 sm:px-6 md:px-16 lg:px-20 overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800">
