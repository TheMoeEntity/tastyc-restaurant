          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="flex-1">
              ...
              <MotionWrapper variant="fade-up" delay={100} className="mt-8">
                <Link
                  href="/menu"
                  className="inline-flex items-center gap-2 text-yellow-500 hover:text-yellow-700 font-semibold transition"
                >
                  <ArrowLeft className="w-4 h-4" />
                  Add more items
                </Link>
                ...
                <MotionWrapper variant="fade-left" delay={200}>
                  <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-5">
                    ...
                    <p className="text-gray-400 text-xs mt-2">
                      Try: FIRST10, WEEKEND20, AFRICAN15, or TASTYC10
                    </p>
                  </div>
                </MotionWrapper>
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-5 space-y-5">
              <div>
                ...
                <div className="space-y-3">
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:border-yellow-400 transition"
                  />
                  <input
                    type="email"
              ...
              {orderType === "delivery" && (
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:border-yellow-400 transition resize-none"
                  />
                </div>
              )}
              ...
              <button
                ...
                className="w-full py-3.5 bg-yellow-500 hover:bg-yellow-400 text-black font-bold rounded-xl transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isPlacingOrder ? (
                  <>
