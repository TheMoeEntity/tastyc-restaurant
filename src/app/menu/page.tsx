...
// ================== CATEGORIES ==================
const categories = [
  { id: "all", name: "All", icon: UtensilsCrossed, color: "bg-gray-100" },
  { id: "Appetizers", name: "Appetizers", icon: Coffee, color: "bg-orange-100" },
  { id: "African Specialties", name: "African", icon: Globe, color: "bg-amber-100" },
  { id: "Intercontinental", name: "Global", icon: ChefHat, color: "bg-green-100" },
  { id: "Desserts", name: "Desserts", icon: Cake, color: "bg-pink-100" },
  { id: "Drinks", name: "Drinks", icon: Wine, color: "bg-blue-100" },
];
...
const addToCart = (item: MenuItem) => {
  ...
  // Optional: Show a small notification (you can style this as you like)
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        <div className={`flex gap-2 transition-all duration-300 overflow-hidden ${isHovered ? "max-h-12 opacity-100" : "max-h-0 opacity-0"}`}>
          <button 
