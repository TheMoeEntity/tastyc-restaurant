...
export default function BlogPopularPage() {
  ...
  // Get top 3 posts for featured section
  ...
  return (
    <main className="bg-gray-50 min-h-screen">
          ...
          {displayedPosts.length === 0 ? (
            <div className="text-center py-12 bg-white rounded-xl">
              ...
              <button
                ...
                className="mt-4 text-yellow-600 hover:text-yellow-700 font-semibold text-sm"
              >
                Reset all filters
              </button>
            </div>
                      ...
                      <div className="p-4 flex-1 flex flex-col">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                          ...
                          <Link
                            ...
                            className="text-yellow-600 text-sm font-medium hover:text-yellow-700 transition"
                          >
                            Read →
                          </Link>
                        </div>
      ...
      {/* NEWSLETTER SECTION - Brand Colors */}
