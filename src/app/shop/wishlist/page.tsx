...
import { getWishlist, removeFromWishlist, addToCart } from "@/lib/utils/shopUtils";
  ...
  return (
    <main className="bg-gray-50 min-h-screen">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <MotionWrapper variant="fade-up">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <p className="text-sm font-bold uppercase tracking-widest text-yellow-500">Saved Items</p>
              <div className="h-0.5 w-6 bg-yellow-500" />
            </div>
      ...
      <div className="text-center pb-16">
        <Link href="/shop" className="inline-flex items-center gap-2 text-yellow-600 hover:text-yellow-700">
