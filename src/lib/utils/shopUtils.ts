// src/lib/utils/shopUtils.ts

import { Product, WishlistItem, Deal, CartItem } from "@/types/shop.types";
...
export const saveAppliedPromo = (code: string, discount: number, minOrder?: number): void => {
  if (typeof window !== "undefined") {
